    ...
    locales: {
      'ar': {
        'glossary': {
          ...
          'Semantic': 'سيمانتك',
          'Semantic Project': 'مشروع سيمانتك',
          ...
          'UI Collections': 'المجموعات',
          'UI Collection': 'مجموعة',
          'Views': 'وسائل العرض',
          'UI Views': 'وسائل العرض',
          'UI View': 'وسيلة عرض',
          'Modules': 'الوَحَدات',
          'UI Modules': 'الوَحَدات',
          'UI Module': 'وحدة',
          'Behavior': 'التصرفات',
          'UI Behavior': 'التصرفات',
          'Style Guide': 'إرشادات',
          'UI Guide': 'دليل واجهة المستخدم',
          ...
          'CSS': 'CSS صفحات الأنماط المتتالية',
          ...
          'Home': 'البداية',
          'Link': 'وصلة',
          'Signed in as': 'تسجيل الدخول بواسطة',
          'User': 'مستخدم',
          'Like': 'أعجبني',
        ...
        'documents':{
          'index':{
            ...
            'CoversationHeader': 'تكلم مع مكونات واجهة المستخدم',
            'CoversationSubheader': 'سيمانتك تعطيك مجموعة متنوعة من مكونات واجهة المستخدم مدعومة ببيانات تتبع التنفيذ، حيث تقوم التعليمات البرمجية يإخباركم ماذايحدث الآن.',
            'OpenConsole': 'قم بفتح أدوات المطورين في المتصفح و توجه إلى شاشة المخرجات',
            'OpenConsoleSubheader': 'سيمانتك توفر لك تتبع لسلوك الجافا سكريبت، بحيث أن المكونات تقوم باطلاعك على ما يحدث فور حدوثه.',
            'GrowingHeader': 'كل يوم في ازدياد',
            'GrowingSubheader': 'يتم تطوير مكونات جديدة باستمرار، تابعنا لرؤية المزيد.',
            'Menu': 'القائمة',
          },
        },
        'partials': {
